...
from E_Mart.models import Product, Categories, Filter_Price, Color, Brand, Tag, Contact_us, Order, OrderItem
...
def CONTACT_PAGE(request):
    if request.method == 'POST':
        ...
        try:
            send_mail(subject, message, email_from, ['vt03052002@gmail.com'])
            contact.save()
